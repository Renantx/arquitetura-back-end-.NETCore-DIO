...
namespace curso.api.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        /// <summary>
        /// Este serviço permite autenticar um usuário cadastrado e ativo.(Login)
        /// </summary>
        /// <param name="loginViewModelInput">View model do login</param>
        /// <returns>Retorna status ok, dados do usuario e o token em caso de sucesso</returns>
        [SwaggerResponse(statusCode: 200, description: "Sucesso de autenticação", Type = typeof(LoginViewModelOutput))]
        ...
        public async Task<IActionResult> Logar(LoginViewModelInput loginViewModelInput)
        {
            try
            {
                ...
                if (usuario == null)
                {
                    return BadRequest("Houve um erro na tentativa de acesso.");
                }
        ...
        /// </summary>
        /// <param name="loginViewModelInput">View model do registro do usuaario</param>
        [SwaggerResponse(statusCode: 201, description: "Sucesso na criação do cadastro", Type = typeof(RegistroViewModelInput))]
        [SwaggerResponse(statusCode: 400, description: "Campo obrigatório", Type = typeof(ValidaCampoViewModelOutput))]
        [SwaggerResponse(statusCode: 500, description: "Erro interno", Type = typeof(ErroGenericoViewModel))]
        [HttpPost]
        [Route("registrar")]
